...
token = str("CTP")
getHolders = str("listnerds,clicktrackprofit,ctptalk,noctp4u,ctpx,he-index,ctpchat,ctptips,null")
payToken = str("INDEX")
payAmount = float(10.0)
payMemo = str("Daily payout based on your CTP stake.")
minOwnedStake = float(1.0)
